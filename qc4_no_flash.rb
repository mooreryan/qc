...
def qual_trim_se! infile:, outfile:, log:
...
all_unpaired = File.join opts[:outdir],
                         "six_and_two.adapters_trimmed.qual_trim.all_unpaired.fq"
...
baseout += ".qual_trim"
qual_trim_pe! in1: both_adapters_trimmed_for_paired,
              in2: both_adapters_trimmed_rev_paired,
              baseout: "#{baseout}.fq",
              log: big_log

qual_trim_se! infile: both_adapters_trimmed_for_unpaired,
              outfile: "#{both_adapters_trimmed_for_unpaired.sub(/.fq$/, "")}.qual_trim.fq",
              log: big_log

qual_trim_se! infile: both_adapters_trimmed_rev_unpaired,
              outfile: "#{both_adapters_trimmed_rev_unpaired.sub(/.fq$/, "")}.qual_trim.fq",
              log: big_log
